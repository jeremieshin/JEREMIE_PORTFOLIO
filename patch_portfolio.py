...
css = r'''
  ...
  :root{
    /* Reference gradient: red/orange -> magenta -> violet, sampled from the supplied image. */
  ...
  /* Work/category navigation: active AND hover use the same reference gradient. */
  .filter-btn.active,
  .filter-btn:hover,
  ...
  /* Full-screen menu: remove the old red hover/active color completely. */
