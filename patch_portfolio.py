...
css = r'''
  ...
  /* Menu and theme controls use the same 42px size and #777777 color. */
  .burger{
  ...
  .global-theme-toggle{
    ...
    color:#777777!important;display:flex!important;align-items:center!important;justify-content:center!important;
    box-sizing:border-box!important;
  }
  .global-theme-toggle svg{width:42px!important;height:42px!important;display:block!important;overflow:visible!important;}
  .global-theme-toggle .theme-label{display:none!important;}
  .global-theme-toggle .theme-mode-dark{display:block!important;}
  .global-theme-toggle .theme-mode-light{display:none!important;}
  body.inverted .global-theme-toggle{color:#777777!important;}
  body.inverted .global-theme-toggle .theme-mode-dark{display:none!important;}
  body.inverted .global-theme-toggle .theme-mode-light{display:block!important;}
...
(() => {
  ...
  ready(() => {
    ...
    /* Keep one theme button only, then rebuild its artwork so dark/light icons can never render simultaneously. */
      ...
      theme.innerHTML = `
        <svg viewBox="0 0 42 42" aria-hidden="true" focusable="false">
          <g fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">
            <path d="M18.2 3.8h5.6l1 3.8c1.25.34 2.45.84 3.55 1.48l3.38-1.98 3.96 3.96-1.98 3.38c.64 1.1 1.14 2.3 1.48 3.55l3.81 1v5.6l-3.81 1c-.34 1.25-.84 2.45-1.48 3.55l1.98 3.38-3.96 3.96-3.38-1.98c-1.1.64-2.3 1.14-3.55 1.48l-1 3.81h-5.6l-1-3.81c-1.25-.34-2.45-.84-3.55-1.48l-3.38 1.98-3.96-3.96 1.98-3.38a14.7 14.7 0 0 1-1.48-3.55l-3.81-1v-5.6l3.81-1c.34-1.25.84-2.45 1.48-3.55l-1.98-3.38 3.96-3.96 3.38 1.98c1.1-.64 2.3-1.14 3.55-1.48l1-3.8Z"/>
          </g>
          <g class="theme-mode-dark" fill="currentColor">
            <path d="M25.7 25.4a8.5 8.5 0 0 1-9.1-10.7 7.7 7.7 0 1 0 9.1 10.7Z"/>
          </g>
          <g class="theme-mode-light" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round">
            <circle cx="21" cy="21" r="4.2"/>
            <path d="M21 12.3V9.8M21 32.2v-2.5M12.3 21H9.8M32.2 21h-2.5M14.9 14.9l-1.8-1.8M28.9 28.9l-1.8-1.8M27.1 14.9l1.8-1.8M13.1 28.9l1.8-1.8"/>
          </g>
        </svg>`;
